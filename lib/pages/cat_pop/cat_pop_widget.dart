...
import 'cat_pop_model.dart';
export 'cat_pop_model.dart';
...
class _CatPopWidgetState extends State<CatPopWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CatPopModel());
  }
              ...
              children: [
                Align(
                  ...
                  child: Row(
                    ...
                    children: [
                      Image.asset(
                        'assets/images/icons8-success-1--unscreen.gif',
                        width: 100.0,
                        height: 60.0,
                        fit: BoxFit.contain,
                      ),
